...
<div class="uk-vertical-align uk-text-center uk-height-1-1">
    <div class="uk-vertical-align-middle" style="width: 250px;">
        <%--<img class="uk-margin-bottom" width="140" height="120"--%>
             ...
             <%--alt="">--%>
        <img class="uk-margin-bottom" width="140" height="120"
             src="${pageContext.request.contextPath}/imges/headportrait.gif"
             alt="">
        <form id="zhm_loginForm" class="uk-panel uk-panel-box uk-form">
            ...
            <div class="uk-form-row">
                <a class="uk-width-1-1 uk-button uk-button-primary uk-button-large" onclick="loginPage.login()">Login</a>
            </div>
